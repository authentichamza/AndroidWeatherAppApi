...
/**************Volley******************/
    ...
    public void UISetter(WeatherProperties weatherProperties){
        ...
        wd = new WeatherDetails(R.drawable.ic_baseline_wb_sunny_24,"Sunrise",weatherProperties.getSys().getSunrise().toString(),R.drawable.sunset,"Sunset",weatherProperties.getSys().getSunset().toString());
        data.add(wd);
        wd = new WeatherDetails(R.drawable.humidity,"Humidity",weatherProperties.getMain().getHumidity().toString(),R.drawable.ic_baseline_get_app_24,"Pressure",weatherProperties.getMain().getPressure().toString());
        data.add(wd);
        wd = new WeatherDetails(R.drawable.ic_baseline_fast_rewind_24,"WindSpeed",weatherProperties.getWind().getSpeed().toString(),R.drawable.ic_baseline_get_app_24,"Pressure",weatherProperties.getMain().getPressure().toString());
        data.add(wd);
